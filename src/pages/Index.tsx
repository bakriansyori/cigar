        ...
        <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
          ...
          >
            ...
            <h1 className="font-serif text-5xl md:text-7xl text-cigar-cream leading-tight mb-6">
              Seni dalam{" "}
              <span className="text-cigar-gold italic">Setiap Linting</span>
            </h1>
            <p className="text-cigar-cream/60 text-lg md:text-xl font-body leading-relaxed mb-10 max-w-xl mx-auto">
              Rasakan kemewahan cerutu pilihan dari seluruh dunia, dipilih dengan
              cermat untuk para penikmat sejati.
            </p>
            <Link
              to="/products"
              className="inline-block border-2 border-cigar-gold text-cigar-gold px-10 py-4 text-sm tracking-widest uppercase hover:bg-cigar-gold hover:text-cigar-dark transition-all duration-300 font-body"
            >
              Lihat Koleksi
            </Link>
          </motion.div>
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-transparent to-cigar-dark">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="text-center mt-12">
            <Link
              to="/products"
              className="inline-block border border-cigar-gold/40 text-cigar-gold px-8 py-3 text-sm tracking-widest uppercase hover:bg-cigar-gold hover:text-cigar-dark transition-all duration-300 font-body"
            >
              Lihat Semua Koleksi
            </Link>
          </div>
